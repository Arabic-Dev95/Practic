...
namespace AMONIC_Airlines_3
{
    class SqlConnect
    {
        private SqlConnection _sqlConnection = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;Initial Catalog=Session1_3_K;Integrated Security=True");
        ...
        public string CheckLogin(string login, string password)
        {
            ...
            if (User.Rows.Count > 0)
                return User.Rows[0][0].ToString() + ";" + User.Rows[0][1].ToString();
            else
                return null;
        }
